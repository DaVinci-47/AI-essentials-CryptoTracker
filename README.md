...
You can then download the .py file from the repo and open using python.
Or you can install Vs code and copy the code from the repo file, paste it into a new .py file in vs code, and run it.
